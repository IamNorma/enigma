...
class AlgorithmTest < Minitest::Test
  ...
  def test_it_can_create_random_digits
    ...
    assert_equal "02715", algorithm.create_random_number
  end
  ...
  def test_it_can_create_keys
    ...
    assert_equal expected, algorithm.create_keys
  end
  ...
  def test_squared_date
    ...
    assert_equal 1649984400, algorithm.squared_date
  end
  ...
  def test_it_can_get_last_four_digits
    ...
    assert_equal 4400, algorithm.last_four_digits
  end
  ...
  def test_it_can_create_offsets
    ...
    assert_equal expected, algorithm.create_offsets
  end
  ...
  def test_it_can_create_final_shifts
    ...
    assert_equal expected, algorithm.final_shifts
  end
  ...
  def test_it_can_encrypt_message
    ...
    assert_equal "nhmqucxtxoe", algorithm.encrypt("Hello World")
    assert_equal "nhmqu,aauumi!", algorithm.encrypt("Hello, World!")
  end
  ...
  def test_it_can_decrypt_message
    ...
    algorithm.stubs(:final_shifts).returns(shifts)
    assert_equal "hello world", algorithm.decrypt("nhmqucxtxoe")
    assert_equal "hello, world!", algorithm.decrypt("nhmqu,aauumi!")
  end
end
